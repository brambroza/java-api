-- PostgreSQL schema. Types mirror what Hibernate expects (ddl-auto=validate is enforced in CI).
...
-- vendor-specific tuning: partial index keeps the "pending" scan tiny
